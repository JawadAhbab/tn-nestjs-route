...
export const RouteGet = (routecls: Function) => createDecor(Get, routecls)
export const RoutePost = (routecls: Function) => createDecor(Post, routecls)

const createDecor = (Method: Method, routecls: Function) => {
  const routeinfo = createRouteInfo(routecls)
